...
const PropertyList = () => {
  ...
  const images = [
    ...
    "https://blog.deliverymuch.com.br/wp-content/uploads/2020/05/110-comidas-preferidas-durante-a-quarentena-e-dicas-para-voc%C3%AA-aplicar-no-seu-neg%C3%B3cio-750x410.jpg",
