...
import { countByCity, countByType, createService, deleteService, getAllservice, getService, getServiceProducts, updateService } from '../controllers/service.js';
...
router.get("/product/:id", getServiceProducts);
